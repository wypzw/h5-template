...
!function () {
    ...
    var c, a, u = document.createElement("canvas"), m = t(), d = "c_n" + m.l, l = u.getContext("2d"),
        ...
        }, x = Math.random, w = {x: null, y: null, max: 2e4};
    ...
    for (var y = [], s = 0; m.n > s; s++) {
        var f = x() * c, h = x() * a, g = 2 * x() - 1, p = 2 * x() - 1;
        y.push({x: f, y: h, xa: g, ya: p, max: 6e3})
    }
    setTimeout(function () {
        i()
    }, 100)
